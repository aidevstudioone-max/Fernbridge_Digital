...
const TEAM = [
  { name: 'Ankit Prakash', role: 'Operations & Data', bio: '11 years in operations and data across Yext and Amazon. Builds the dashboards and automation behind the scenes.', color: '#1D5C3C' },
  ...
  { name: 'Bhuvanesh Meethal', role: 'Delivery', bio: '5 years in finance and healthcare operations with a 98%+ client satisfaction record. Keeps delivery on schedule.', color: '#4F46E5' },
  { name: 'Chandan Jha', role: 'Engineering Lead', bio: '10+ years building Ruby on Rails platforms across Munich, Stuttgart, and Bengaluru. Leads the build — first line of code to what ships in production.', color: '#16150E' },
]
